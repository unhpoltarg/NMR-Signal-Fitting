...
with open('Freq Sweeping\\121020fits.csv', mode='w', newline='', encoding='utf-8-sig') as Dec20File:
...
with open('Freq Sweeping\\121020flats.csv', mode='w', newline='', encoding='utf-8-sig') as Dec20File2:
